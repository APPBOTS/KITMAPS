...
public class GeotificationsViewController: UIViewController, AddGeotificationsViewControllerDelegate, MKMapViewDelegate, CLLocationManagerDelegate {
...
public  override func viewDidLoad() {
 ...
 public override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
  ...
  func updateGeotificationsCount() {
    title = "Geo-Notificaciones (\(geotifications.count))"
